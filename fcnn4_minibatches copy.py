...
class NN():
  ...
  def backward(self, X, Y, l_rate=0.01, epochs=10, minibatch_size=128, keep_prob=1, X_cv=np.array([]), Y_cv=np.array([])):
    # J_history = []
    # J_cv_history = []
    for epoch in range(1, epochs+1):
      ...
      for t in range(num_minibatches):
        # Save old values of W, b, J for printing results of this batch
